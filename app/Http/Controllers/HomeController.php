...
class HomeController extends Controller
{
    ...
    {
        Meta::addMeta('title', __('Giveaways Finance Giveways'));
        Meta::addMeta('keywords', __('crypto giveaway, crypto quest, crypto tasks, campaigns, quests, crypto, prize fair launch, GAS tokens, boost tokens'));
        Meta::addMeta('description', __('Dive into the latest crypto quests  and win crypto giveaways at Giveaways Finance. Be a part of our community and discover the latest projects that a looking for you. Start your journey into the crypto verse without breakings a sweat!"'));
