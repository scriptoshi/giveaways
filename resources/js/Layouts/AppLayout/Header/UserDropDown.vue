...
<template>
	...
	>
		...
		>
			<MenuItems
				class="aside bottom place-left origin-top-right absolute right-0 mt-5 w-56 rounded-md shadow-lg pt-4 bg-white dark:bg-gray-800 ring-1 ring-gray-300 dark:ring-gray-600 ring-opacity-5 focus:outline-none"
			>
				<div
					class="tip"
				...
				>
					<InertiaLink
						...
						:class="[
							...
							'group flex items-center px-6 py-2 text-sm hover:bg-emerald-200/50 hover:text-emerald-600 dark:hover:bg-emerald-600/20 dark:hover:text-emerald-300',
						]"
					>
						<component
							:is="item.icon"
				...
				<MenuItem as="div">
					...
					<InertiaLink
						href="#"
						@click="logout"
						class="group text-gray-700 dark:text-gray-300 flex items-center px-6 py-3 text-sm hover:bg-gray-200 dark:hover:bg-gray-600"
					>
						<Loading
							v-if="load"
