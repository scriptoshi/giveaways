...
import ProjectCard from "@/Pages/Projects/Index/ProjectCard.vue";
defineProps({
	projects: Object,
	popular: Array,
});
...
debouncedWatch(
	...
	([searchBy, orderBy, orderDir]) => {
		...
		router.visit(window.route("projects.index", {search, by, order}), {
			preserveScroll: true,
		});
	},
	{debounce: 500},
				...
				<div class="lg:col-span-2 mt-8">
					...
					>
						<ProjectCard
							...
							:project="project"
						/>
						<PaginationSquare :meta="projects.meta" />
					</div>
					<div
						v-else
