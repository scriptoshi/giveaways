...
const form = useForm({
	...
	brief: props.service.brief,
	title: props.service.title,
	category: props.service.category,
	tags: props.service.tags ?? [],
	description: props.service.description,
	telegram: props.service.telegram,
	...useFormUploadParams("image"),
	image_path: props.service.image.path,
	image_uri: props.service.image.url,
});
...
const draft = async () => {
	form.put(window.route("services.update", {ad: props.service.uuid}), {
		preserveScroll: true,
		onSuccess() {
			form.reset();
		},
					...
					<div class="grid mx-auto max-w-4xl">
						...
						<div class="mt-12 w-full flex space-x-3 items-center justify-end">
							<PrimaryButton
								secondary
								link
								:href="route('services.index', {show: 'mine'})"
							>
								{{ $t("My Services") }}
							</PrimaryButton>
							<PrimaryButton
