...
const commons = ["website", "docs", "youtube_trailer", "telegram", "twitter", "discord"];
const socials = [
	"whitepaper",
	"facebook",
	"github",
...
const titles = {
	...
	youtube_trailer: {
		label: t("YouTube Trailer Link"),
		placeholder: t("https://youtu.be/yOurNicETraiLer"),
	},
	telegram: {
		...
		<div class="grid gap-y-4 w-full">
			...
			<div class="w-full grid">
				...
				<ProjectDescriptionTextArea
					v-model="description"
					:placeholder="$t('Enter a brief description of your project')"
				/>
				<p
				...
				<p v-else>{{ $t("Provide a brief description of your project.") }}</p>
			</div>
